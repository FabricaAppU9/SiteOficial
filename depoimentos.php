				...
				<div style="display: block;">
					<div>
						<div style="width: 100%; left: 0px; display: block;" >
							<div class="row">
								<div class="col-md-6" style="background-color:#FFFFFF;border-radius:5px;padding:10px; margin-bottom:10px;">
								...
								<!--Depoimento Heraldo-->
								<div class="col-md-6" style="background-color:#FFFFFF;border-radius:5px;padding:10px; margin-left:10px; margin-bottom:15px;">
									<div class="feedback-box">
										<div class="message">
