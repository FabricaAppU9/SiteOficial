		...
		<div style="visibility: hidden; -webkit-animation-name: none; -moz-animation-name: none; animation-name: none;-webkit-animation-duration: 3s; -moz-animation-duration: 3s; animation-duration: 3s;-webkit-animation-delay: 0.15s; -moz-animation-delay: 0.15s; animation-delay: 0.15s;" class="row wow fadeInRight animated" data-wow-offset="40" data-wow-duration="3s" data-wow-delay="0.15s">
				...
				<div class="team-member" style="margin-bottom:0px !important;">
					...
					<div class="social-icons">
						<ul>
							...
							<li><a target="_blank" href="https://www.linkedin.com/in/daniele-prado-cavalcante-rodrigues-31abaa119?trk=hp-identity-photo"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
							<li><a target="_blank" href="https://github.com/danielerodrigues"><i class="fa fa-github" aria-hidden="true"></i></a></li>
							<!--<li><a target="_blank" href=""><i class="fa fa-skype"></i></a></li>-->
						</ul>
					</div>
				</div>
			...
			<!-- <div class="col-lg-3 col-sm-3">
				<div class="team-member">
					<figure class="profile-pic">
						<img src="Zerif%20-%20Responsive%20One%20Page%20Template_arquivos/marcelamenezes.jpg" alt="">
					</figure>
					<div class="member-details">
						<h5 class="dark-text yellow-border-bottom">Marcela Menezes</h5>
						<div class="position">
							<p>Teste de qualidade maio/2016 - Atual</p>
						</div>
					</div>
					<div class="social-icons">
						<ul>
			...
			<div class="col-lg-3 col-sm-3">
				<div class="team-member" style="margin-bottom:0px !important;">
					...
					<div class="social-icons">
						<ul>
							 <!-- <li><a href=""><i class="fa fa-facebook-official" aria-hidden="true"></i></a></li> -->
							<li><a href="https://www.linkedin.com/in/jonathan-de-paulo-souza-3bb935125"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
							<li><a href="https://github.com/JonathanP157"><i class="fa fa-github" aria-hidden="true"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-3 col-sm-3">
				<div class="team-member" style="margin-bottom:0px !important;">
					...
					<div class="social-icons">
						<ul>
							<!-- <li><a href=""><i class="fa fa-facebook-official" aria-hidden="true"></i></a></li>  -->
							<li><a href="https://br.linkedin.com/in/ricardo-henrique-mota-9a1033104"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
							<li><a href="https://github.com/ricardohenrique"><i class="fa fa-github" aria-hidden="true"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
			<!--<div class="col-lg-3 col-sm-3">
				<div class="team-member">
					...
					<div class="member-details">
						...
						<div class="position">
							<p>Programador maio/2016 - ago/2016</p>
						</div>
					</div>
					<div class="social-icons">
						<ul>
